...
import org.structr.mqtt.entity.MQTTSubcriber;

public class MQTTSubscribers extends OneToMany<MQTTClient, MQTTSubcriber>{
	...
	@Override
	public Class<MQTTSubcriber> getTargetType() {
		return MQTTSubcriber.class;
	}
